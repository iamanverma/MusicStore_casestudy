...
-- Q5. Who is the best customer? The customer who has spent the most money will be declared the best customer. Write a query that returns the peroson
...
-- Q10. we want to find out the most popular genre for each country. We determine the most popular genere as the genre with high amount of purchases. 
-- Write a Query tht returns each country along with the top genre. For countries where the maximum numbver of purchaes is shared return all genres.for
